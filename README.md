...
The resulting model weights of both, Pre-Trained and From-Scratch models, are available for download via a Google Drive link provided in the training_weights directory.
